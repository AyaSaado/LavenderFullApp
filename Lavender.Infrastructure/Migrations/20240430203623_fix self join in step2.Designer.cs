...
namespace Lavender.Infrastructure.Migrations
{
    ...
    [Migration("20240430203623_fix self join in step2")]
    partial class fixselfjoininstep2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Lavander.Core.Entities.Design", b =>
                {
                    ...
                    b.Property<int>("ProductionLine_Id")
                        .HasColumnType("int");

                    b.Property<Guid?>("TailorId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("Tailor_Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lavander.Core.Entities.MakerSection", b =>
                {
                    ...
                    b.Property<int>("DesigningSection_Id")
                        .HasColumnType("int");

                    b.Property<Guid>("PatternMakerId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("PatternMaker_Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lavander.Core.Entities.SItemType", b =>
                {
                    ...
                    b.Property<int>("StoreItem_Id")
                        .HasColumnType("int");

                    b.Property<int>("Stype_Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lavander.Core.Entities.Work", b =>
                {
                    ...
                    b.Property<int>("ProductionEmp_Id")
                        .HasColumnType("int");
